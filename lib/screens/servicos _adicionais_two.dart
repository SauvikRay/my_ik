                            ...
                            const  Divider(thickness: 1,color: Colors.black26,),
                              ...
                              Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                    children:<Widget>[
                                     const Expanded(child: Text('Caixas (cada)',style:TextStyle(fontFamily: 'Poppins',fontWeight: FontWeight.normal,fontSize:16,color: Colors.black),)),
                                      Row(children:const <Widget> [
                                        Text('09',style:TextStyle(fontFamily: 'Poppins',fontWeight: FontWeight.normal,fontSize:12,color: Colors.black),),
                                        Icon(Icons.keyboard_arrow_down_rounded,color: Colors.purpleAccent,size: 20,),
                                      ],),
                                      IconButton(onPressed: (){}, icon:const Icon(Icons.delete,color: Colors.purpleAccent,),iconSize: 20,),
