                  ...
                  children:<Widget> [
                    Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                             Text('Escolha o tipo de casa',style:head4?.copyWith(color: Colors.black),),
                            IconButton(onPressed: (){}, icon: Icon(Icons.keyboard_arrow_down_rounded,color: Colors.purpleAccent,size: 25.w,),),
                          ],
                        )
                    ),
                   Text(
