...
class ServiceAdicionaisScreenOne extends StatefulWidget {
  ...
  @override
  _ServiceAdicionaisScreenOneState createState() =>
      _ServiceAdicionaisScreenOneState();
}

class _ServiceAdicionaisScreenOneState
    extends State<ServiceAdicionaisScreenOne> {
  String _value = "Nenhum serviço adicional";
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text(_value,
                                  style: head5?.copyWith(color: Colors.black)),
                              PopupMenuButton(
                                  icon: const Icon(
                                  ...
                                  itemBuilder: (BuildContext context) {
                                    return [
                                      ...
                                      PopupMenuItem(
                                        child: Text(
                                          'Rolo de filme com 450 metros - 11€',
                                          style: head5?.copyWith(
                                              color: Colors.black),
                                        ),
                                        value: "Rolo filme 450 metros - 11€",
                                      ),
                                      PopupMenuItem(
                                        child: Text(
                                          'Caixas (cada) - 3.30€',
                                        ...
                                        value: "Caixas (cada) - 3.30€",
                                      ),
                                      PopupMenuItem(
                                        child: Text(
                                          'Rolo de papel cartão - 56€',
                                          style: head5?.copyWith(
                                              color: Colors.black),
                                        ),
                                        value: "Rolo papel cartão - 56€",
                                      ),
                                      PopupMenuItem(
                                        child: Text(
                                          'Elevador Extern o - 185€',
                                          style: head5?.copyWith(
                                              color: Colors.black),
                                        ),
                                        value: "Elevador o - 185€",
                                      ),
                                    ];
                                  }),

                              //const Icon(Icons.keyboard_arrow_down_rounded,color: AppColors.highLightText,),
                              Text(
                                'Qtd.',
                                style: sub2?.copyWith(color: Colors.black),
                              ),
                              Icon(
                                Icons.keyboard_arrow_down_rounded,
                ...
                customeButton(
                    context: context, name: 'Próximo', onCallBack: () {}),
                SizedBox(
                  height: 10.h,
                ),
              ],
